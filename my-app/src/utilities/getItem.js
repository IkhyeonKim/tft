...
const getFullItems = (firstItem, secondItem) => {
    ...
    const fullList = [ 
        ...
        ['SparingGloves','RepeatingCrossbow']],
        'Chain_Vest',
        ...
        ['SparingGloves','Mittens']],
        'SparingGloves',
        [['B_F_Sword', 'Infinity_Edge'],
        ['Recurve_Bow','RepeatingCrossbow'],
        ['Chain_Vest', 'IcebornGauntlet'],
        ['Negatron_Cloak', 'Quicksilver'],
        ['Needlessly_Large_Rod', 'JeweledGauntlet'],
        ['Tear_of_the_Goddess', 'HandofJustice'],
        ['Giant_s_Belt', 'Backhand'],
        ['Spatula', 'Mittens'],
        ['SparingGloves','ThiefsGloves']],
    ]
